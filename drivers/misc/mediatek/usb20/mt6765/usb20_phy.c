...
#if defined(CONFIG_MACH_MT6765_DH40LM)//LGSI -DH40 Q-OS porting from P-OS
#define VAL_MAX_WIDTH_4        0xF
#define SHFT_RG_USB20_ENHANCEMENT 30
...
void set_usb_phy_mode(int mode)
{
	...
	/* VBUSVALID=1, AVALID=1, BVALID=1, SESSEND=0, IDDIG=1, IDPULLUP=1 */
		...
		#if defined(CONFIG_MACH_MT6762_DH30XLM)
		/* Set driving capability for Device mode (0x7+0x7=14)*/
		USBPHY_CLR32(OFFSET_RG_USB20_VRT_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_VRT_VREF_SEL, 0x7 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_CLR32(OFFSET_RG_USB20_TERM_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_TERM_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_TERM_VREF_SEL, 0x7 << SHFT_RG_USB20_TERM_VREF_SEL);
		#elif defined(CONFIG_MACH_MT6765_EH35LM)
		/* Set driving capability for EH35 Device mode (0x6+0x6=12)*/
		USBPHY_CLR32(OFFSET_RG_USB20_VRT_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_VRT_VREF_SEL, 0x6 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_CLR32(OFFSET_RG_USB20_TERM_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_TERM_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_TERM_VREF_SEL, 0x6 << SHFT_RG_USB20_TERM_VREF_SEL);
		#elif defined(CONFIG_MACH_MT6762_MH45LM)
		/* Set driving capability for MH45 Device mode (0x5+0x5=10)*/
		USBPHY_CLR32(OFFSET_RG_USB20_VRT_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_VRT_VREF_SEL, 0x5 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_CLR32(OFFSET_RG_USB20_TERM_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_TERM_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_TERM_VREF_SEL, 0x5 << SHFT_RG_USB20_TERM_VREF_SEL);
		#else
		/* Set driving capability for Device mode (0x4+0x4=8)*/
		USBPHY_CLR32(OFFSET_RG_USB20_VRT_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_VRT_VREF_SEL, 0x4 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_CLR32(OFFSET_RG_USB20_TERM_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_TERM_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_TERM_VREF_SEL, 0x4 << SHFT_RG_USB20_TERM_VREF_SEL);
		#endif
		break;
	...
	/* VBUSVALID=1, AVALID=1, BVALID=1, SESSEND=0, IDDIG=0, IDPULLUP=1 */
		...
		USBPHY_SET32(0x6c, (0x3f<<8));
		#if defined(CONFIG_MACH_MT6762_DH30XLM)
		/* Set driving capability for Host mode (0x4+0x4=8)*/
		USBPHY_CLR32(OFFSET_RG_USB20_VRT_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_VRT_VREF_SEL, 0x4 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_CLR32(OFFSET_RG_USB20_TERM_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_TERM_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_TERM_VREF_SEL, 0x4 << SHFT_RG_USB20_TERM_VREF_SEL);
		...
		USBPHY_SET32(OFFSET_RG_USB20_VRT_VREF_SEL, 0x7 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_CLR32(OFFSET_RG_USB20_TERM_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_TERM_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_TERM_VREF_SEL, 0x0 << SHFT_RG_USB20_TERM_VREF_SEL);
		USBPHY_CLR32(OFFSET_RG_USB20_PHY_REV6, VAL_MAX_WIDTH_2 << SHFT_RG_USB20_ENHANCEMENT);
		USBPHY_SET32(OFFSET_RG_USB20_PHY_REV6, 0x2 << SHFT_RG_USB20_ENHANCEMENT);
		USBPHY_CLR32(OFFSET_RG_USB20_PHY_REV6, VAL_MAX_WIDTH_4 << SHFT_RG_USB20_SQTH);
		USBPHY_SET32(OFFSET_RG_USB20_PHY_REV6, 0x4 << SHFT_RG_USB20_SQTH);
		#else
		/* Set driving capability for HOST mode (0x4+0x4=8)*/
		USBPHY_CLR32(OFFSET_RG_USB20_VRT_VREF_SEL, VAL_MAX_WIDTH_3 << SHFT_RG_USB20_VRT_VREF_SEL);
		USBPHY_SET32(OFFSET_RG_USB20_VRT_VREF_SEL, 0x4 << SHFT_RG_USB20_VRT_VREF_SEL);
